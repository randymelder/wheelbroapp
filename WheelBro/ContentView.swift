// ContentView.swift
// Root navigation shell — three-tab layout with first-launch routing logic.
...
struct ContentView: View {
    ...
    // First launch  → start on Settings tab (index 1) so the user configures their setup.
    ...
    init() {
        ...
        _selectedTab = State(initialValue: launched ? 0 : 1)
    }
